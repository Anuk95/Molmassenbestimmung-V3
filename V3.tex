...
\newpage
\section{Theorie}
In der Bestimmung der Molmasse nach Viktor Meyer wird die Molmasse einer leicht verdampfbaren Substanz mithilfe des von ihr verdrängten Gasvolumens beim Verdampfen bestimmt. Dabei handelt es sich um ein flüchtiges Gas, d.h. es verdampft schon bei Zimmertemperatur. In den Berechnungen wird näherungsweise von einem idealen Verhalten der Luft, sowie der verdampften Substanz und der Mischung beider ausgegangen. Es wird also angenommen, dass sich diese Gase wie ideale Gase verhalten und sich das ideale Gasgesetz auf sie anwenden lässt.\\\\
